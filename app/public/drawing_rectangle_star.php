...
<body>
    ...
    <div>
        ...
        <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
            ...
            <input type="number" id="width" name="width" value="<?php if (isset($width)) {
                echo $width;
                                                                }?>" required placeholder="Please typing integer, Ex: 1">
            <br><br>
            <label for="height">Input height: <span style="color: red"> *</span></label>
            <input type="number" id="height" name="height" value="<?php if (isset($height)) {
                echo $height;
                                                                  }?>" required placeholder="Please typing integer, Ex: 1">
            <br><br>
