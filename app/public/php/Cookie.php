...
<body>
    <div>
        ...
        <form method="post" action="index.php">
            <input type="radio" name="animal" value="cat" id="animal">
            <label for="animal"> I love cat</label><br><br>

            <input type="radio" name="animal" value="dog" id="animal">
            <label for="animal"> I love dog</label><br><br>

            <input type="radio" name="animal" value="snake" id="animal">
            <label for="animal"> I love snake</label><br><br>

            <input type="radio" name="animal" value="bird" id="animal">
